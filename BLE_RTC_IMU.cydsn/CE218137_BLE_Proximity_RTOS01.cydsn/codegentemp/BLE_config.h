 ...
 */
#define CY_BLE_CAPSENSE_PROXIMITY_SERVICE_INDEX   (0x00u) /* Index of CapSense Proximity service in the cy_ble_customs array */
#define CY_BLE_CAPSENSE_PROXIMITY_CAPSENSE_PROXIMITY_CHAR_INDEX   (0x00u) /* Index of CapSense Proximity characteristic */
#define CY_BLE_CAPSENSE_PROXIMITY_CAPSENSE_PROXIMITY_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_CAPSENSE_PROXIMITY_CAPSENSE_PROXIMITY_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_CAPSENSE_PROXIMITY_SERVICE_HANDLE   (0x000Cu) /* Handle of CapSense Proximity service */
#define CY_BLE_CAPSENSE_PROXIMITY_CAPSENSE_PROXIMITY_DECL_HANDLE   (0x000Du) /* Handle of CapSense Proximity characteristic declaration */
#define CY_BLE_CAPSENSE_PROXIMITY_CAPSENSE_PROXIMITY_CHAR_HANDLE   (0x000Eu) /* Handle of CapSense Proximity characteristic */
#define CY_BLE_CAPSENSE_PROXIMITY_CAPSENSE_PROXIMITY_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_CAPSENSE_PROXIMITY_CAPSENSE_PROXIMITY_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */
