// ======================================================================
// RestEaze_BLE.v generated from TopDesign.cysch
// 11/05/2020 at 08:56
...
module top ;
    ...
    TCPWM_Counter_PDL_v1_0_6 Timer_IMU (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
    ...
    TCPWM_Counter_PDL_v1_0_7 Timer_PPG (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
    ...
    TCPWM_Counter_PDL_v1_0_8 Counter_ms (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
